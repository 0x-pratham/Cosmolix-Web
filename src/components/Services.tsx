...
import { Brain, Code2, Cloud, BarChart3, Monitor, GraduationCap, ArrowRight } from 'lucide-react'
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
            ...
            >
              Services Built
              <em style={{ color: '#2563EB', fontStyle: 'italic' }}> for Scale</em>
            </h2>
            <p
              style={{
                fontFamily: 'DM Sans, sans-serif',
            ...
            >
              From AI research to enterprise cloud platforms, we deliver solutions
          ...
          <div
            style={{
              marginTop: '2rem',
              height: '1px',
              background: 'linear-gradient(90deg, #2563EB 0%, rgba(37,99,235,0.1) 60%, transparent 100%)',
            }}
          />
        </div>
        ...
        >
          <a
            ...
            onMouseEnter={e => ((e.currentTarget as HTMLAnchorElement).style.borderColor = '#2563EB')}
            onMouseLeave={e => ((e.currentTarget as HTMLAnchorElement).style.borderColor = 'rgba(37,99,235,0.3)')}
          >
            View all services
            <ArrowRight size={15} />
          </a>
